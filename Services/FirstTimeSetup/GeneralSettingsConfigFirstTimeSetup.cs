...
{
    /// <summary>
    /// First-time setup service for GeneralSettingsConfig configuration sections.
    /// </summary>
    public class GeneralSettingsConfigFirstTimeSetup : IConfigSectionFirstTimeSetupService
    {
        /// <summary>
        /// Runs the first-time setup for a GeneralSettingsConfig section to fix missing or invalid fields.
        /// </summary>
