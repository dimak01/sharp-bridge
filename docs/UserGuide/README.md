...
Welcome to the Sharp Bridge User Guide! This guide will help you get started with Sharp Bridge plugin nd learn how to use its features effectively.
...
4. ⚠️ **Grant VTube Studio PC API access** - When prompted in VTS PC, click "Allow" to grant SharpBridge plugin access
5. ⚠️ **Grant Windows Firewall access** - When Windows asks about network access, click "Allow access" (recommended) or use in-app help to configure manually later
6. **Follow setup prompts** if this is your first time
7. **Watch the progress** during initialization
8. **Monitor connections** in Main Status mode
9. **Explore different modes** - Press F1 for System Help or F2 for Network Status
10. **Review settings** - Use Ctrl+Alt+E to edit configurations as needed  
